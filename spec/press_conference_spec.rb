...
describe 'PressConference class' do
  ...
  it 'should form a query for fighter from fighter POV' do
    ...
    stub_puts_and_gets_statements(press_conference)
  ...
  def stub_puts_and_gets_statements(press_conference)
    ...
    allow(press_conference).to receive(:press_enter_to_continue)
  end
